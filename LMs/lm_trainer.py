...
from data_utils.dgl_dataset import Dataset
from data_utils.load import load_data
from utils import init_path, time_logger
#WANDB_DISABLED=True TOKENIZERS_PARALLELISM=False CUDA_VISIBLE_DEVICES=0 python -m trainLM
...
class LMTrainer():
    def __init__(self, cfg):
        ...
        self.model_path = cfg.lm.model.path
